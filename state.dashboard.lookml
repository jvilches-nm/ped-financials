- dashboard: state
  ...
  - name: State Overview
    ...
    body_text: "###Overview of state education finances - includes all district and\
      ...
      \ of terms please click <a href=\"https://openbooks.ped.nm.gov/learn-more/\"\
      \ target=\"_PARENT\">here</a>.\n\nFiscal year data for 2021-2022 is currently\
      \ up to date as of quarter one. Data will be updated throughout the year as\
      \ the financials are approved in the Operating Budget Management System. "
    row: 0
    col: 0
    width: 24
    height: 4
