- dashboard: district
  ...
  - name: Overview
    ...
    body_text: "District financial numbers on this page do not include local charter\
      ...
      \ Management System.\
      \ \n\nStarting 2022-2023, District School Approved Actual data Year to Date will\
      \ be displayed.\
      \ \n\nStudent Information for 2022-2023 will be available when data is submitted\
      \ and approved in mid-December."
    row: 0
    col: 0
    width: 24
    height: 3
  - title: Avg Spending per District Student to Date
    ...
    note_display: hover
    note_text: |-
      Total district expenditures for the selected school year not including capital or debt service funds divided by the number of district students based on the 40-day count for that school year. This average should be considered an estimate for comparison purposes and not an actual tally of the spending per student. Off-site and charter students are not included in these calculations.
    model: ped_public_financials
    explore: actuals_line
    type: single_value
  ...
  - title: Avg Instructional Spending per District Student to Date
    ...
    note_display: hover
    note_text: |-
       Total district expenditures for the selected school year categorized with an Instructional function not including capital or debt service funds divided by the number of district students based on the 40-day count for that school year. This average should be considered an estimate for comparison purposes and not an actual tally of the spending per student. Off-site and charter students are not included in these calculations.
    model: ped_public_financials
    explore: actuals_line
    type: single_value
    fields: [actuals_line.amount, stars_districts.public_student_pop]
